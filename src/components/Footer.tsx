  ...
  return (
    <footer className="app-footer">
      <div className="footer-content">
        <span>© {new Date().getFullYear()} | Coded by Tilak Vasu</span>
        <div className="social-links">
          {/* IMPORTANT: Replace '#' with your actual links */}
          <a href="https://github.com/tilak-vasu" aria-label="GitHub">{githubIcon}</a>
          <a href="https://linkedin.com/in/tilakvasu" aria-label="LinkedIn">{linkedinIcon}</a>
          <a href="mailto:tilakvasu02@gmail.com" aria-label="Email">{mailIcon}</a>
        </div>
      </div>
    </footer>
  );
